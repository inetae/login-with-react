...
const Servers = () => {
    ...
    const getServers = async () => {
        ...
        await axios.get('http://localhost:3000/api/servers', config)
            .then((response) => {
    ...
    if (isLoading) return <div className={style.svgWrapper}>
    ...
    return !state.error && state.posts ? (
